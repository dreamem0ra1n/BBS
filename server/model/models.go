...
type User struct {
	...
	Greeting                      string         `gorm:"size:80" json:"greeting" form:"greeting"`                            // 在线列表问候语
...
type Comment struct {
	...
	CreateTime     int64  `json:"createTime" form:"createTime"`                                               // 创建时间
	LastEditUserId int64  `gorm:"not null;default:0" json:"lastEditUserId" form:"lastEditUserId"`             // 最后编辑用户
	LastEditTime   int64  `gorm:"not null;default:0" json:"lastEditTime" form:"lastEditTime"`                 // 最后编辑时间
